...
#include "panel-animation.h"
#include "panel-frame-source.h"
...
G_DEFINE_TYPE (PanelAnimation, panel_animation, G_TYPE_INITIALLY_UNOWNED)
 ...
 * Globals.
 */
static AlphaFunc   alpha_funcs[PANEL_ANIMATION_LAST];
...
/**
 * panel_animation_alpha_ease_in_cubic:
 ...
 */
static gdouble
panel_animation_alpha_ease_in_cubic (gdouble offset)
{
...
static gdouble
panel_animation_alpha_ease_out_cubic (gdouble offset)
{
...
static gdouble
panel_animation_alpha_ease_in_out_cubic (gdouble offset)
{
 ...
 */
static gdouble
panel_animation_alpha_linear (gdouble offset)
{
  return offset;
}
...
/**
 * panel_animation_alpha_ease_in_quad:
 * @offset: (in): The position within the animation; 0.0 to 1.0.
 *
 * An alpha function to transform the offset within the animation.
 ...
 */
static gdouble
panel_animation_alpha_ease_in_quad (gdouble offset)
{
...
/**
 * panel_animation_alpha_ease_out_quad:
 * @offset: (in): The position within the animation; 0.0 to 1.0.
 *
 * An alpha function to transform the offset within the animation.
 ...
 */
static gdouble
panel_animation_alpha_ease_out_quad (gdouble offset)
{
...
/**
 * panel_animation_alpha_ease_in_out_quad:
 * @offset: (in): The position within the animation; 0.0 to 1.0.
 *
 * An alpha function to transform the offset within the animation.
 * @PANEL_ANIMATION_EASE_IN_OUT_QUAD means that the value will be transformed
 ...
 */
static gdouble
panel_animation_alpha_ease_in_out_quad (gdouble offset)
{
  offset *= 2.0;
  if (offset < 1.0)
...
/**
 * panel_animation_load_begin_values:
 * @animation: (in): A #PanelAnimation.
 *
 ...
 */
static void
panel_animation_load_begin_values (PanelAnimation *animation)
{
  g_assert (PANEL_IS_ANIMATION (animation));
...
/**
 * panel_animation_unload_begin_values:
 * @animation: (in): A #PanelAnimation.
 *
 ...
 */
static void
panel_animation_unload_begin_values (PanelAnimation *animation)
{
  g_assert (PANEL_IS_ANIMATION (animation));
...
/**
 * panel_animation_get_offset:
 * @animation: A #PanelAnimation.
 ...
 */
static gdouble
panel_animation_get_offset (PanelAnimation *animation,
                            gint64          frame_time)
{
  g_assert (PANEL_IS_ANIMATION (animation));
...
/**
 * panel_animation_update_property:
 * @animation: (in): A #PanelAnimation.
 * @target: (in): A #GObject.
 ...
 */
static void
panel_animation_update_property (PanelAnimation *animation,
                                 gpointer        target,
                                 Tween          *tween,
                                 const GValue   *value)
{
...
/**
 * panel_animation_get_value_at_offset:
 * @animation: (in): A #PanelAnimation.
 ...
 */
static void
panel_animation_get_value_at_offset (PanelAnimation *animation,
                                     gdouble         offset,
                                     Tween          *tween,
                                     GValue         *value)
{
...
static void
panel_animation_set_frame_clock (PanelAnimation *animation,
...
static void
panel_animation_target_unrealize_cb (PanelAnimation *animation,
                                     GtkWidget      *widget)
{
  g_assert (PANEL_IS_ANIMATION (animation));
  ...
  panel_animation_stop (animation);
}


static void
panel_animation_set_target (PanelAnimation *animation,
                            gpointer        target)
{
  ...
  if (GTK_IS_WIDGET (animation->target))
    {
      animation->unrealize_handler =
        g_signal_connect_swapped (animation->target,
                                  "unrealize",
                                  G_CALLBACK (panel_animation_target_unrealize_cb),
                                  animation);
      panel_animation_set_frame_clock (animation,
                                       gtk_widget_get_frame_clock (animation->target));
    }
}

/**
 * panel_animation_tick:
 * @animation: (in): A #PanelAnimation.
 *
 ...
 */
static gboolean
panel_animation_tick (PanelAnimation *animation,
                       gdouble          offset)
{
  gdouble alpha;
  GValue value = { 0 };
  ...
  for (i = 0; i < animation->tweens->len; i++)
    {
      ...
      panel_animation_get_value_at_offset (animation, alpha, tween, &value);
      panel_animation_update_property (animation,
                                       animation->target,
                                       tween,
                                       &value);
      g_value_unset (&value);
...
/**
 * panel_animation_timeout_cb:
 * @user_data: (in): A #PanelAnimation.
 *
 ...
 */
static gboolean
panel_animation_timeout_cb (gpointer user_data)
{
  PanelAnimation *animation = user_data;
  gboolean ret;
  gdouble offset;

  offset = panel_animation_get_offset (animation, 0);

  if (!(ret = panel_animation_tick (animation, offset)))
    panel_animation_stop (animation);
...
static gboolean
panel_animation_widget_tick_cb (GdkFrameClock   *frame_clock,
...
static void
panel_animation_widget_after_paint_cb (GdkFrameClock   *frame_clock,
                                       PanelAnimation *animation)
{
  gint64 base_time;
  gint64 interval;
  ...
  offset = panel_animation_get_offset (animation, next_frame_time);

  panel_animation_tick (animation, offset);
}


/**
 * panel_animation_start:
 * @animation: (in): A #PanelAnimation.
 *
 ...
 */
void
panel_animation_start (PanelAnimation *animation)
{
  g_return_if_fail (PANEL_IS_ANIMATION (animation));
  g_return_if_fail (!animation->tween_handler);

  g_object_ref_sink (animation);
  panel_animation_load_begin_values (animation);
  ...
  if (animation->frame_clock)
    {
      ...
      animation->tween_handler =
        g_signal_connect_object (animation->frame_clock,
                                 "update",
                                 G_CALLBACK (panel_animation_widget_tick_cb),
                                 animation,
                                 0);
      animation->after_paint_handler =
        g_signal_connect_object (animation->frame_clock,
                                 "after-paint",
                                 G_CALLBACK (panel_animation_widget_after_paint_cb),
                                 animation,
                                 0);
  ...
  else
    {
      ...
      animation->end_time = animation->begin_time + (animation->duration_msec * 1000L);
      animation->tween_handler = panel_frame_source_add (FALLBACK_FRAME_RATE,
                                                         panel_animation_timeout_cb,
                                                         animation);
    }
}
...
static void
panel_animation_notify (PanelAnimation *self)
{
  g_assert (PANEL_IS_ANIMATION (self));
...
/**
 * panel_animation_stop:
 * @animation: (nullable): A #PanelAnimation.
 *
 ...
 */
void
panel_animation_stop (PanelAnimation *animation)
{
  if (animation == NULL)
    return;
  ...
  if (animation->tween_handler)
    {
      ...
      panel_animation_unload_begin_values (animation);
      panel_animation_notify (animation);
 ...
 */
void
panel_animation_add_property (PanelAnimation *animation,
                              GParamSpec      *pspec,
                              const GValue    *value)
{
  Tween tween = { 0 };
...
/**
 * panel_animation_dispose:
 * @object: (in): A #PanelAnimation.
 *
 ...
 */
static void
panel_animation_dispose (GObject *object)
{
  PanelAnimation *self = PANEL_ANIMATION (object);

  g_clear_object (&self->target);
  g_clear_object (&self->frame_clock);

  G_OBJECT_CLASS (panel_animation_parent_class)->dispose (object);
}


/**
 * panel_animation_finalize:
 * @object: (in): A #PanelAnimation.
 *
 ...
 */
static void
panel_animation_finalize (GObject *object)
{
  PanelAnimation *self = PANEL_ANIMATION (object);
  Tween *tween;
  guint i;
  ...
  G_OBJECT_CLASS (panel_animation_parent_class)->finalize (object);
}


/**
 * panel_animation_set_property:
 * @object: (in): A #GObject.
 ...
 */
static void
panel_animation_set_property (GObject      *object,
                              guint         prop_id,
                              const GValue *value,
                              GParamSpec   *pspec)
{
  PanelAnimation *animation = PANEL_ANIMATION (object);
  ...
  switch (prop_id)
    ...
    case PROP_FRAME_CLOCK:
      panel_animation_set_frame_clock (animation, g_value_get_object (value));
      break;
    ...
    case PROP_TARGET:
      panel_animation_set_target (animation, g_value_get_object (value));
      break;
...
/**
 * panel_animation_class_init:
 * @klass: (in): A #PanelAnimationClass.
 *
 ...
 */
static void
panel_animation_class_init (PanelAnimationClass *klass)
{
  GObjectClass *object_class;
  const gchar *slow_down_factor_env;

  debug = !!g_getenv ("PANEL_ANIMATION_DEBUG");
  slow_down_factor_env = g_getenv ("PANEL_ANIMATION_SLOW_DOWN_FACTOR");

  if (slow_down_factor_env)
    slow_down_factor = MAX (1, atoi (slow_down_factor_env));

  object_class = G_OBJECT_CLASS (klass);
  object_class->dispose = panel_animation_dispose;
  object_class->finalize = panel_animation_finalize;
  object_class->set_property = panel_animation_set_property;
...
#define SET_ALPHA(_T, _t) \
  alpha_funcs[PANEL_ANIMATION_ ## _T] = panel_animation_alpha_ ## _t
...
/**
 * panel_animation_init:
 * @animation: (in): A #PanelAnimation.
 *
 * Initializes the #PanelAnimation instance.
 *
 * Side effects: Everything.
 */
static void
panel_animation_init (PanelAnimation *animation)
{
  animation->duration_msec = 250;
  animation->mode = PANEL_ANIMATION_EASE_IN_OUT_QUAD;
...
/**
 * panel_animation_mode_get_type:
 *
 * Retrieves the GType for #PanelAnimationMode.
 *
 * Returns: A GType.
 * Side effects: GType registered on first call.
 */
GType
panel_animation_mode_get_type (void)
{
  static GType type_id = 0;
  static const GEnumValue values[] = {
    { PANEL_ANIMATION_LINEAR, "PANEL_ANIMATION_LINEAR", "linear" },
    { PANEL_ANIMATION_EASE_IN_QUAD, "PANEL_ANIMATION_EASE_IN_QUAD", "ease-in-quad" },
    { PANEL_ANIMATION_EASE_IN_OUT_QUAD, "PANEL_ANIMATION_EASE_IN_OUT_QUAD", "ease-in-out-quad" },
    { PANEL_ANIMATION_EASE_OUT_QUAD, "PANEL_ANIMATION_EASE_OUT_QUAD", "ease-out-quad" },
    { PANEL_ANIMATION_EASE_IN_CUBIC, "PANEL_ANIMATION_EASE_IN_CUBIC", "ease-in-cubic" },
    { PANEL_ANIMATION_EASE_OUT_CUBIC, "PANEL_ANIMATION_EASE_OUT_CUBIC", "ease-out-cubic" },
    { PANEL_ANIMATION_EASE_IN_OUT_CUBIC, "PANEL_ANIMATION_EASE_IN_OUT_CUBIC", "ease-in-out-cubic" },
    { 0 }
  };

  if (G_UNLIKELY (!type_id))
    type_id = g_enum_register_static ("PanelAnimationMode", values);
  return type_id;
}

/**
 * panel_object_animatev:
 * @object: A #GObject.
 ...
 *
 * Returns: (transfer none): A #PanelAnimation.
 */
PanelAnimation *
panel_object_animatev (gpointer             object,
                       ...
                       va_list              args)
{
  ...
  g_return_val_if_fail (mode < PANEL_ANIMATION_LAST, NULL);
  ...
  animation = g_object_new (PANEL_TYPE_ANIMATION,
  ...
  do
    {
      ...
      panel_animation_add_property (animation, pspec, &value);
      g_value_unset (&value);
    }
  while ((name = va_arg (args, const gchar *)));

  panel_animation_start (animation);
                      ...
                      ...)
{
  ...
  animation = panel_object_animatev (object, mode, duration_msec, frame_clock, first_property, args);
  va_end (args);
...
guint
panel_animation_calculate_duration (GdkMonitor *monitor,
                                    gdouble     from_value,
                                    gdouble     to_value)
{
  GdkRectangle geom;
