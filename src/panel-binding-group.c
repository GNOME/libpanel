...
/**
 * SECTION:panel-binding-group
 * @title: PanelBindingGroup
 * @short_description: Manage a collection of #GBindings on
 *      a #GObject as a group.
 *
 * #PanelBindingGroup manages to simplify the process of binding
...
G_DEFINE_TYPE (PanelBindingGroup, panel_binding_group, G_TYPE_OBJECT)
...
static void
panel_binding_group_connect (PanelBindingGroup *self,
                             LazyBinding       *lazy_binding)
{
  GBinding *binding;

  g_assert (PANEL_IS_BINDING_GROUP (self));
...
static void
panel_binding_group_disconnect (LazyBinding *lazy_binding)
{
  g_assert (lazy_binding != NULL);
...
static void
panel_binding_group__source_weak_notify (gpointer  data,
                                         GObject  *where_object_was)
{
  PanelBindingGroup *self = data;
  gsize i;
...
static void
panel_binding_group__target_weak_notify (gpointer  data,
                                         GObject  *where_object_was)
{
  PanelBindingGroup *self = data;
  gsize i;
  ...
  if (lazy_binding->target != NULL)
    {
      g_object_weak_unref (lazy_binding->target,
                           panel_binding_group__target_weak_notify,
                           lazy_binding->group);
      lazy_binding->target = NULL;
    }

  panel_binding_group_disconnect (lazy_binding);
...
static void
panel_binding_group_dispose (GObject *object)
{
  PanelBindingGroup *self = (PanelBindingGroup *)object;
  ...
  if (self->source != NULL)
    {
      g_object_weak_unref (self->source,
                           panel_binding_group__source_weak_notify,
                           self);
      self->source = NULL;
    }
  ...
  G_OBJECT_CLASS (panel_binding_group_parent_class)->dispose (object);
}

static void
panel_binding_group_finalize (GObject *object)
{
  PanelBindingGroup *self = (PanelBindingGroup *)object;
  ...
  G_OBJECT_CLASS (panel_binding_group_parent_class)->finalize (object);
}

static void
panel_binding_group_get_property (GObject    *object,
                                  guint       prop_id,
                                  GValue     *value,
                                  GParamSpec *pspec)
{
  PanelBindingGroup *self = PANEL_BINDING_GROUP (object);

  switch (prop_id)
    {
    case PROP_SOURCE:
      g_value_set_object (value, panel_binding_group_get_source (self));
      break;
...
static void
panel_binding_group_set_property (GObject      *object,
                                  guint         prop_id,
                                  const GValue *value,
                                  GParamSpec   *pspec)
{
  ...
  switch (prop_id)
    {
    case PROP_SOURCE:
      panel_binding_group_set_source (self, g_value_get_object (value));
      break;
...
static void
panel_binding_group_class_init (PanelBindingGroupClass *klass)
{
  GObjectClass *object_class = G_OBJECT_CLASS (klass);

  object_class->dispose = panel_binding_group_dispose;
  object_class->finalize = panel_binding_group_finalize;
  object_class->get_property = panel_binding_group_get_property;
  object_class->set_property = panel_binding_group_set_property;

  /**
   * PanelBindingGroup:source
   *
...
static void
panel_binding_group_init (PanelBindingGroup *self)
{
  self->lazy_bindings = g_ptr_array_new_with_free_func (lazy_binding_free);
}

/**
 * panel_binding_group_new:
 *
 * Creates a new #PanelBindingGroup.
 *
 * Returns: a new #PanelBindingGroup
 */
PanelBindingGroup *
panel_binding_group_new (void)
{
  return g_object_new (PANEL_TYPE_BINDING_GROUP, NULL);
}

/**
 * panel_binding_group_get_source:
 * @self: the #PanelBindingGroup
 *
 ...
 */
GObject *
panel_binding_group_get_source (PanelBindingGroup *self)
{
  g_return_val_if_fail (PANEL_IS_BINDING_GROUP (self), NULL);

  return self->source;
}

static gboolean
panel_binding_group_check_source (PanelBindingGroup *self,
                                  gpointer           source)
{
  gsize i;
...
/**
 * panel_binding_group_set_source:
 * @self: the #PanelBindingGroup
 ...
 */
void
panel_binding_group_set_source (PanelBindingGroup *self,
                                gpointer           source)
{
  g_return_if_fail (PANEL_IS_BINDING_GROUP (self));
  ...
  if (source != NULL && panel_binding_group_check_source (self, source))
    {
      gsize i;
      ...
      for (i = 0; i < self->lazy_bindings->len; i++)
        {
          ...
          lazy_binding = g_ptr_array_index (self->lazy_bindings, i);
          panel_binding_group_connect (self, lazy_binding);
        }
    }
...
static void
panel_binding_group_bind_helper (PanelBindingGroup *self,
                                 const gchar       *source_property,
                                 gpointer           target,
                                 const gchar       *target_property,
                                 GBindingFlags      flags,
 ...
 */
void
panel_binding_group_bind (PanelBindingGroup *self,
                          const gchar       *source_property,
                          gpointer           target,
                          const gchar       *target_property,
                          GBindingFlags      flags)
{
  panel_binding_group_bind_full (self, source_property,
 ...
 */
void
panel_binding_group_bind_full (PanelBindingGroup     *self,
                               const gchar           *source_property,
                               gpointer               target,
                               const gchar           *target_property,
                               GBindingFlags          flags,
                               ...
                               GDestroyNotify         user_data_destroy)
{
  panel_binding_group_bind_helper (self, source_property,
                                   target, target_property,
                                   flags,
...
/**
 * panel_binding_group_bind_with_closures: (rename-to panel_binding_group_bind_full)
 * @self: the #PanelBindingGroup
 * @source_property: the property on the source to bind
 * @target: (type GObject): the target #GObject
 * @target_property: the property on @target to bind
 ...
 * panel_binding_group_bind_property_full(), using #GClosures
 * instead of function pointers.
 *
 * See: g_object_bind_property_with_closures().
 */
void
panel_binding_group_bind_with_closures (PanelBindingGroup *self,
                                        const gchar       *source_property,
                                        gpointer           target,
                                        const gchar       *target_property,
                                        GBindingFlags      flags,
